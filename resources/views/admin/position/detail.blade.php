...
<div class="d-sm-flex justify-content-between align-items-center mb-3">
    <h1 class="h3 mb-0">Detail Jabatan</h1>
</div>
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header"><h5 class="card-title mb-0">{{ $position->name }} ({{ $position->group ? $position->group->name : '-' }})</h5></div>
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-hover table-bordered" id="datatable">
                        ...
                        <tbody>
                            @foreach($position->users()->where('role_id','=',role('member'))->where('end_date','=',null)->orderBy('name','asc')->get() as $user)
                            <tr>
