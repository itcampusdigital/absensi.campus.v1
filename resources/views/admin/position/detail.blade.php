...
<main class="app-content">
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.office.index') }}">Jabatan</a></li>
            <li class="breadcrumb-item">Detail Jabatan</li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <div class="tile-title-w-btn">
                    <div></div>
                    <h5>{{ $position->name }} ({{ $position->group ? $position->group->name : '-' }})</h5>
                </div>
                <div class="tile-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm table-hover table-bordered" id="table">
                            ...
                            <tbody>
                                @foreach($position->users()->where('role','=',role('member'))->where('end_date','=',null)->get() as $user)
                                    <tr>
